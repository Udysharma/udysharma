...
> Note: the snake animation above requires a scheduled GitHub Action (e.g. `Platane/snk`) writing to an `output` branch. If it doesn't render, that workflow likely isn't set up yet.
